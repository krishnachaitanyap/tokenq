...
- [2. BanditRouter — Thompson-sampling model router](#2-banditrouter--thompson-sampling-model-router)
  - [Idea](#idea)
  - [Flow](#flow)
  - [Reward function (live mode)](#reward-function-live-mode)
  - [Shadow reward (counterfactual)](#shadow-reward-counterfactual)
  - [Graduation / demotion](#graduation--demotion)
  - [Where bandit savings show up](#where-bandit-savings-show-up)
- [3. OutputController — turn-class-aware output caps](#3-outputcontroller--turn-class-aware-output-caps)
  - [Classifier](#classifier)
  - [Levers (per class)](#levers-per-class)
  - [Effect on dashboard](#effect-on-dashboard)
- [4. TranscriptCompactor — sliding-window prefix compaction](#4-transcriptcompactor--sliding-window-prefix-compaction)
  - [Idea](#idea-1)
  - [Flow](#flow-1)
  - [4.1 Orphan tool_result guard](#41-orphan-tool_result-guard)
  - [Cache stability invariant](#cache-stability-invariant)
- [5. SkillLoader — relevance-prune skill descriptions](#5-skillloader--relevance-prune-skill-descriptions)
  - [Flow](#flow-2)
- [6. BigMemoryInjectStage — session-stable memory injection](#6-bigmemoryinjectstage--session-stable-memory-injection)
  - [Cache-stability trick](#cache-stability-trick)
  - [Effect on dashboard](#effect-on-dashboard-1)
- [7. ExactMatchCache — local response cache](#7-exactmatchcache--local-response-cache)
  - [Key](#key)
  - [Hit / miss flow](#hit--miss-flow)
  - [Why output tokens count as savings](#why-output-tokens-count-as-savings)
- [8. ToolResultDedup — stub repeated tool_result content](#8-toolresultdedup--stub-repeated-tool_result-content)
  - [Flow](#flow-3)
  - [Per-turn vs per-request scope](#per-turn-vs-per-request-scope)
- [9. ToolOutputCompressor — trim & ANSI-strip tool_result content](#9-tooloutputcompressor--trim--ansi-strip-tool_result-content)
  - [Flow](#flow-4)
  - [The "only credit last-message savings" rule](#the-only-credit-last-message-savings-rule)
- [10. BigMemoryStage — capture-only tool_result store](#10-bigmemorystage--capture-only-tool_result-store)
- [11. Dashboard metric reference](#11-dashboard-metric-reference)
  - [11.1 Bottom-line comparison (`comparison` block)](#111-bottom-line-comparison-comparison-block)
  - [11.2 Usage totals (`totals` block)](#112-usage-totals-totals-block)
  - [11.3 Savings-by-stage breakdown](#113-savings-by-stage-breakdown)
  - [11.4 Bandit / shadow KPIs](#114-bandit--shadow-kpis)
  - [11.5 Time series (`/api/timeseries`, hourly or daily)](#115-time-series-apitimeseries-hourly-or-daily)
  - [11.6 Per-model rollup (`/api/by_model`)](#116-per-model-rollup-apiby_model)
  - [11.7 Health grade (`/api/health`)](#117-health-grade-apihealth)
  - [11.8 Sessions / projects / tools / activity / shell / mcp](#118-sessions--projects--tools--activity--shell--mcp)
  - [11.9 One-shot rate (`/api/oneshot`)](#119-one-shot-rate-apioneshot)
- [12. Database tables — column-level guide](#12-database-tables--column-level-guide)
  - [`requests`](#requests)
  - [`compaction_events`](#compaction_events)
  - [`bandit_shadow_decisions`](#bandit_shadow_decisions)
  - [`cache`](#cache)
  - [`bandit_state`](#bandit_state)
  - [`memory_items` / `memory_snapshots`](#memory_items--memory_snapshots)
  - [`skill_compressions`](#skill_compressions)
- [13. End-to-end timing of one turn](#13-end-to-end-timing-of-one-turn)
- [14. Multi-turn conversations: how history accumulates](#14-multi-turn-conversations-how-history-accumulates)
  - [14.1 The premise](#141-the-premise)
  - [14.2 What Anthropic's prompt cache does](#142-what-anthropics-prompt-cache-does)
  - [14.3 The cache-stability invariant](#143-the-cache-stability-invariant)
  - [14.4 What runs on every turn vs once-per-rollover](#144-what-runs-on-every-turn-vs-once-per-rollover)
  - [14.5 Compaction in action — turn-by-turn timeline](#145-compaction-in-action--turn-by-turn-timeline)
  - [14.6 What "saved tokens" counts on each turn](#146-what-saved-tokens-counts-on-each-turn)
  - [14.7 Where session identity comes from](#147-where-session-identity-comes-from)
  - [14.8 The two cache layers](#148-the-two-cache-layers)
  - [14.9 Failure modes you'd see in the dashboard](#149-failure-modes-youd-see-in-the-dashboard)
